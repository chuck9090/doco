...
window.chrome.webRequest.onBeforeSendHeaders.addListener(details => {
	...
	urls: ["*://www.linkedin.com/voyager/api/*", "*://www.linkedin.com/recruiter/api/*",
...
function getLinkedInProfileInfo(linkedin_user_id) {
	if (linkedin_user_id) return fetch(
			`http://www.linkedin.com/voyager/api/identity/profiles/${linkedin_user_id}/profileView`, {
